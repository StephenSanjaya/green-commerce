...
func (c *productServiceClient) GetAllProduct(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ProductResponses, error) {
	out := new(ProductResponses)
...
func (c *productServiceClient) UpdateProduct(ctx context.Context, in *ProductId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (UnimplementedProductServiceServer) UpdateProduct(context.Context, *ProductId) (*emptypb.Empty, error) {
...
func _ProductService_GetAllProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetAllProduct(ctx, req.(*emptypb.Empty))
	}
...
func _ProductService_UpdateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).UpdateProduct(ctx, req.(*ProductId))
	}
	return interceptor(ctx, in, info, handler)
}
